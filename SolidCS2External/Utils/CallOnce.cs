...
public class OnceFlag
{
    ...
    /// Gets a value indicating whether the CheckIfCalledAndSet property has been called and set. </summary> <remarks>
    /// This property internally uses Interlocked.Exchange method to atomically set the state of _state field to Called,
    /// and then checks if the previous state was set to NotCalled. </remarks> <returns>
    /// "true" if the CheckIfCalledAndSet property has been called and set; otherwise, "false". </returns>
    /// /
